...
void ANSIFilterApp::printVersionInfo()
{
  cout << "\n ansifilter version "
       << ANSIFILTER_VERSION
       << "\n Copyright (C) 2007-2010 Andre Simon <andre.simon1 at gmx.de>"
       << "\n\n Argparser class"
...
cout << "\nFile handling:\n";
cout << "  -i, --input=<file>   Input file (optional)\n";
cout << "  -o, --output=<file>  Output file (optional)\n";
...
cout << "  -p, --plain          Ignore formatting information\n";
cout << "\nOther options:\n";
